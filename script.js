...
const fontData = {
 gothic: [
  ...
  { name: "명조체03", value: "'Ridibatang', serif" },
  { name: "명조체04", value: "'JoseonShinmyeongjo', serif" },
  { name: "명조체05", value: "'JoseonBoldMyongjo', serif" },
  { name: "명조체06", value: "'MaruBuri', serif" },
  { name: "명조체07", value: "'MapoAemin', serif" },
  { name: "명조체08", value: "'Iropke Batang', serif" },
  { name: "명조체09", value: "'HsBombaram21', serif" },
  { name: "명조체10", value: "'JeonnamEducationTtobaks', serif" },
